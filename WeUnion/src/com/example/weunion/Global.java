...
public class Global {
    ...
    public static ArrayList<String> joined_event_list = new ArrayList<String>(),my_event_list = new ArrayList<String>(),all_event_list  = new ArrayList<String>(),
    ...
    public static ArrayList<Integer> joined_event_id_list = new ArrayList<Integer>(),my_event_id_list = new ArrayList<Integer>(),all_event_id_list = new ArrayList<Integer>();
