...
public class Global {
	...
	public static final String SHOW_GUEST_URL = "http://124.244.60.23/weu/showguest.php";
	public static final String POLLINGID_URL = "http://124.244.60.23/weu/readpollingbyid.php";
